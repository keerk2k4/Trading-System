...
public interface PositionMapper {
     ...
     */
    @Insert("""
        INSERT INTO positions (trading_account_id, instrument_id, product_type, quantity, average_price, realized_pnl, position_status, opened_at, updated_at)
        VALUES (#{position.account.accountId}, #{position.instrument.instrumentId}, #{position.productType}, #{position.quantity}, #{position.averagePrice}, 0, 'OPEN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
        """)
